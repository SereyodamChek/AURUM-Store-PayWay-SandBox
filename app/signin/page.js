...
export default function SignInPage() {
  ...
  const [fieldValues, setFieldValues] = useState({ email: false, password: false });
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .feature-list {
          ...
          opacity: 0; animation: fadeSlide 0.75s cubic-bezier(0.22,1,0.36,1) 0.72s forwards;
        }
        .feature-item {
        ...
        .feature-icon svg { width: 14px; height: 14px; stroke: var(--gold); fill: none; stroke-width: 1.6; stroke-linecap: round; stroke-linejoin: round; }
        .feature-text { font-size: 13px; color: var(--text2); line-height: 1.5; }
        .feature-text strong { color: var(--text); font-weight: 500; display: block; font-size: 13.5px; }
        ...
        .meta-row {
          ...
          margin-bottom: 20px;
          opacity: 0; animation: fadeSlide 0.65s cubic-bezier(0.22,1,0.36,1) 0.68s forwards;
        }
        .remember-box { display: flex; align-items: center; gap: 9px; cursor: pointer; }
        .custom-check {
        ...
        .custom-check svg {
          width: 9px; height: 9px; stroke: var(--gold); fill: none;
          stroke-width: 2.5; stroke-linecap: round; stroke-linejoin: round;
          opacity: 0; transform: scale(0);
          transition: all 0.25s cubic-bezier(0.34,1.56,0.64,1);
        }
        .custom-check.checked svg { opacity: 1; transform: scale(1); }
        .remember-label { font-size: 12.5px; color: var(--text2); user-select: none; }
        .forgot-link {
        ...
        .cta-block {
          margin-top: 8px;
          opacity: 0; animation: fadeSlide 0.65s cubic-bezier(0.22,1,0.36,1) 0.76s forwards;
        }
        .cta {
        ...
        .signup-lnk:hover::after { transform: scaleX(1); }
      ...
      <div className="page">
        ...
        <div className="left">
          ...
          <div className="left-body">
            <div className="badge"><span className="badge-dot" />Welcome Back</div>
            <h2 className="left-heading">Your space<br />awaits <em>you,</em><br />always.</h2>
            <p className="left-desc">
              Every session picks up exactly where you left off. Your work, your preferences, your world — unchanged.
            </p>
            <div className="feature-list">
              <div className="feature-item">
                ...
                <div className="feature-text">
                  ...
                  End-to-end encryption on every session.
                </div>
              </div>
              <div className="feature-item">
                <div className="feature-icon">
                ...
                <div className="feature-text">
                  ...
                  Resume your workspace in under a second.
                </div>
              </div>
              <div className="feature-item">
                <div className="feature-icon">
                ...
                <div className="feature-text">
                  ...
                  Priority assistance available 24 / 7.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="testi-wrap">
            <div className="testi">
              <p className="testi-text">"Signing back in feels like coming home. Everything is exactly where I left it — and somehow better."</p>
              <div className="testi-author">
                <div className="testi-av">MK</div>
                <div>
                  <div className="testi-name">Marcus Klein</div>
                  <div className="testi-role">Lead Designer, Forma Studio</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div ref={cardRef} className={`form-shell ${mounted ? "mounted" : ""}`}>
            ...
            <div className="prog-section">
              <div className="prog-header">
                <span className="prog-title">Sign In</span>
                <span className="prog-pct">{Math.round((progress / 2) * 100)}%</span>
              </div>
              <div className="prog-track">
                <div className="prog-fill" style={{ width: `${(progress / 2) * 100}%` }} />
              </div>
            </div>

            <h1 className="form-title">Welcome<br /><span>back.</span></h1>
            <p className="form-sub">Good to see you again — sign in to continue.</p>
            ...
            <div className="social-btns">
              ...
              <button type="button" className="soc-btn">
                <svg viewBox="0 0 24 24" fill="none" width="16" height="16">
                  ...
                  <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 5.7 23 12 23z" fill="#34A853"/>
            ...
            <div className={`field${focused === "password" ? " f-focused" : ""}${fieldValues.password ? " f-filled" : ""}`}>
              ...
              <div className="field-row">
                ...
                <input className="f-input" type={showPass ? "text" : "password"} placeholder="Your password"
                  value={form.password}
                  onFocus={() => setFocused("password")} onBlur={() => setFocused(null)}
                  onChange={(e) => handleChange("password", e.target.value)} autoComplete="current-password" />
            ...
            <div className="meta-row">
              <div className="remember-box" onClick={() => setRememberMe(!rememberMe)}>
            ...
            <div className="signup-txt">
              New to Aurum?{" "}
              <Link href="/signup" className="signup-lnk">Create an account</Link>
            </div>
          </div>
        </div>
      </div>
